...
def test_parse_scontrol_show_job_output():
    ...
    job_info_expected = {
        ...
        'SubmitLine': '/opt/slurm/25.11.3/bin/sbatch --hold --time=10-0:0:0 --nodes=1 --exclusive --cpus-per-task=1 --job-name=bot_test_job /home/eessibot/job.slurm',
        'WorkDir': '/home/eessibot/shared/jobs/2026.01/pr_123/event_123-456-789/run_000/riscv64/generic/dev.eessi.io-riscv-2025.06-001',
        'StdErr': '',
        'StdIn': '/dev/null',
        'StdOut': '/home/eessibot/shared/jobs/2026.01/pr_123/event_123-456-789/run_000/riscv64/generic/dev.eessi.io-riscv-2025.06-001/slurm-123.out',
        'TresPerTask': 'cpu=1',
    }
