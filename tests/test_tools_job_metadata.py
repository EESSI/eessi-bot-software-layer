...
def test_determine_job_id_from_job_directory(tmpdir):
    logfile = os.path.join(tmpdir, "test_determine_job_id_from_job_directory.log")

    job_dir = os.path.join(tmpdir, "5")
    ...
    not_job_dir = os.path.join(tmpdir, "not-a-job-dir")
